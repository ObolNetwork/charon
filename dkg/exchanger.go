...
const (
	...
	// sendTimeout is the per-attempt p2p send timeout during DKG ceremonies. Ceremony peers
	// may lag behind (e.g. slower operators or relay-routed connections), so sends get much
	// more headroom than the 7s p2p default.
