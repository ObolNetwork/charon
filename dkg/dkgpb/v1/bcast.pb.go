...
func file_dkg_dkgpb_v1_bcast_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_dkg_dkgpb_v1_bcast_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_dkg_dkgpb_v1_bcast_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_dkg_dkgpb_v1_bcast_proto_msgTypes[2].Exporter = func(v any, i int) any {
