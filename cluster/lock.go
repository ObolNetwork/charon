...
func (l Lock) VerifySignatures(eth1 eth1wrap.EthClientRunner, partialClusterDefinition bool) error {
	if err := l.Definition.VerifySignatures(eth1, partialClusterDefinition); err != nil {
		return errors.Wrap(err, "invalid definition")
	}
