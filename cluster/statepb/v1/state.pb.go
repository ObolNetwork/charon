...
type Cluster struct {
	...
	Hash         []byte       `protobuf:"bytes,1,opt,name=hash,proto3" json:"hash,omitempty"`                                     // Hash is the hash of first signed mutation, uniquely identifying cluster. It must be 32 bytes.
	Name         string       `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`                                     // Name is the name of the cluster.
	Threshold    int32        `protobuf:"varint,3,opt,name=threshold,proto3" json:"threshold,omitempty"`                          // Threshold is the threshold of the cluster.
	DkgAlgorithm string       `protobuf:"bytes,4,opt,name=dkg_algorithm,json=dkgAlgorithm,proto3" json:"dkg_algorithm,omitempty"` // DKGAlgorithm is the DKG algorithm used to create the validator keys of the cluster.
	ForkVersion  []byte       `protobuf:"bytes,5,opt,name=fork_version,json=forkVersion,proto3" json:"fork_version,omitempty"`    // ForkVersion is the fork version (network/chain) of the cluster. It must be 4 bytes.
	Operators    []*Operator  `protobuf:"bytes,6,rep,name=operators,proto3" json:"operators,omitempty"`                           // Operators is the list of operators of the cluster.
	Validators   []*Validator `protobuf:"bytes,7,rep,name=validators,proto3" json:"validators,omitempty"`                         // Validators is the list of validators of the cluster.
}
...
func (x *Empty) Reset() {
	*x = Empty{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cluster_statepb_v1_state_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Empty) Descriptor() ([]byte, []int) {
	return file_cluster_statepb_v1_state_proto_rawDescGZIP(), []int{8}
}
...
var file_cluster_statepb_v1_state_proto_rawDesc = []byte{
	...
	0x22, 0x92, 0x02, 0x0a, 0x07, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x12, 0x12, 0x0a, 0x04,
	...
	,
	...
	0x74, 0x61, 0x22, 0x80, 0x01, 0x0a, 0x0e, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x4d, 0x75, 0x74,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x38, 0x0a, 0x08, 0x6d, 0x75, 0x74, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65,
	0x72, 0x2e, 0x73, 0x74, 0x61, 0x74, 0x65, 0x70, 0x62, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x75, 0x74,
	...
	,
	...
	0x65, 0x79, 0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x75, 0x62, 0x5f, 0x73, 0x68, 0x61, 0x72, 0x65, 0x73,
	0x18, 0x02, 0x20, 0x03, 0x28, 0x0c, 0x52, 0x09, 0x70, 0x75, 0x62, 0x53, 0x68, 0x61, 0x72, 0x65,
	0x73, 0x12, 0x32, 0x0a, 0x15, 0x66, 0x65, 0x65, 0x5f, 0x72, 0x65, 0x63, 0x69, 0x70, 0x69, 0x65,
	...
	,
...
var file_cluster_statepb_v1_state_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_cluster_statepb_v1_state_proto_goTypes = []interface{}{
	(*Cluster)(nil),               // 0: cluster.statepb.v1.Cluster
	(*Mutation)(nil),              // 1: cluster.statepb.v1.Mutation
	(*SignedMutation)(nil),        // 2: cluster.statepb.v1.SignedMutation
	(*SignedMutationList)(nil),    // 3: cluster.statepb.v1.SignedMutationList
	(*Operator)(nil),              // 4: cluster.statepb.v1.Operator
	(*Validator)(nil),             // 5: cluster.statepb.v1.Validator
	(*ValidatorList)(nil),         // 6: cluster.statepb.v1.ValidatorList
	(*LegacyLock)(nil),            // 7: cluster.statepb.v1.LegacyLock
	(*Empty)(nil),                 // 8: cluster.statepb.v1.Empty
	(*timestamppb.Timestamp)(nil), // 9: google.protobuf.Timestamp
	(*anypb.Any)(nil),             // 10: google.protobuf.Any
}
var file_cluster_statepb_v1_state_proto_depIdxs = []int32{
	4,  // 0: cluster.statepb.v1.Cluster.operators:type_name -> cluster.statepb.v1.Operator
	5,  // 1: cluster.statepb.v1.Cluster.validators:type_name -> cluster.statepb.v1.Validator
	9,  // 2: cluster.statepb.v1.Mutation.timestamp:type_name -> google.protobuf.Timestamp
	10, // 3: cluster.statepb.v1.Mutation.data:type_name -> google.protobuf.Any
	1,  // 4: cluster.statepb.v1.SignedMutation.mutation:type_name -> cluster.statepb.v1.Mutation
	2,  // 5: cluster.statepb.v1.SignedMutationList.mutations:type_name -> cluster.statepb.v1.SignedMutation
	5,  // 6: cluster.statepb.v1.ValidatorList.validators:type_name -> cluster.statepb.v1.Validator
...
func file_cluster_statepb_v1_state_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cluster_statepb_v1_state_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Empty); i {
			case 0:
				return &v.state
			case 1:
