...
| `app_beacon_node_sse_block_processing_time` | Histogram | Time in seconds between block gossip event and head event, indicating block processing time. Lower values indicate better CPU/disk/RAM performance. | `addr` |
