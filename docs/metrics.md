...
| `app_beacon_node_sse_block_processing_time_seconds` | Gauge | Most recent block processing time in seconds (time between block gossip and head events). Lower values indicate better CPU/disk/RAM performance. | `addr` |
