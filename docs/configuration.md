...
Flags:
  ...
  -h, --help                                     Help for run
      ...
      --vc-tls-cert-file string                  The path to the TLS certificate file used by the Validator Client for secure communication.
      --vc-tls-key-file string                   The path to the TLS key file used by the Validator Client for secure communication.
