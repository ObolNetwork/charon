...
Flags:
  ...
  -h, --help                                     Help for run
      ...
      --vc-tls-cert-file string                  The path to the TLS certificate file used by charon for secure communication with the validator client.
      --vc-tls-public-key-file string            The path to the TLS public key file used by the validator client for secure communication with charon.
