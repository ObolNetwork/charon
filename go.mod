...
replace github.com/attestantio/go-eth2-client => github.com/ObolNetwork/go-eth2-client v0.28.0-obol.2-gloas-v1.7.0-alpha2 //nolint

// We're replacing temporarily go-builder-client with a branch off our fork. This is to be removed once go-builder-client includes dynamic-ssz.
replace github.com/attestantio/go-builder-client => github.com/ObolNetwork/go-builder-client v0.0.0-20260319131832-9f3465599f38 //nolint
