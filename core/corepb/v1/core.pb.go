...
func file_core_corepb_v1_core_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_core_corepb_v1_core_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Duty); i {
			case 0:
				return &v.state
			case 1:
		...
		file_core_corepb_v1_core_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_core_corepb_v1_core_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_core_corepb_v1_core_proto_msgTypes[3].Exporter = func(v any, i int) any {
