...
type ShareSigExchangeMsg struct {
...
func (x *ShareSigExchangeMsg) Reset() {
	*x = ShareSigExchangeMsg{}
...
func (x *ShareSigExchangeMsg) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ShareSigExchangeMsg) ProtoMessage() {}

func (x *ShareSigExchangeMsg) ProtoReflect() protoreflect.Message {
	mi := &file_core_corepb_v1_parsigex_proto_msgTypes[0]
...
// Deprecated: Use ShareSigExchangeMsg.ProtoReflect.Descriptor instead.
func (*ShareSigExchangeMsg) Descriptor() ([]byte, []int) {
	return file_core_corepb_v1_parsigex_proto_rawDescGZIP(), []int{0}
}

func (x *ShareSigExchangeMsg) GetDuty() *Duty {
	if x != nil {
		return x.Duty
	}
	return nil
...
func (x *ShareSigExchangeMsg) GetDataSet() *ShareSignedDataSet {
	if x != nil {
		return x.DataSet
	}
	return nil
...
var file_core_corepb_v1_parsigex_proto_rawDesc = []byte{
	...
	,
...
var file_core_corepb_v1_parsigex_proto_goTypes = []interface{}{
	(*ShareSigExchangeMsg)(nil), // 0: core.corepb.v1.ShareSigExchangeMsg
...
var file_core_corepb_v1_parsigex_proto_depIdxs = []int32{
	1, // 0: core.corepb.v1.ShareSigExchangeMsg.duty:type_name -> core.corepb.v1.Duty
	2, // 1: core.corepb.v1.ShareSigExchangeMsg.data_set:type_name -> core.corepb.v1.ShareSignedDataSet
...
func file_core_corepb_v1_parsigex_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_core_corepb_v1_parsigex_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ShareSigExchangeMsg); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
