...
type ParSigExchangeMsg struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Duty    *Duty               `protobuf:"bytes,1,opt,name=duty,proto3" json:"duty,omitempty"`
	DataSet *ShareSignedDataSet `protobuf:"bytes,2,opt,name=data_set,json=dataSet,proto3" json:"data_set,omitempty"`
}

func (x *ParSigExchangeMsg) Reset() {
	*x = ParSigExchangeMsg{}
...
func (x *ParSigExchangeMsg) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ParSigExchangeMsg) ProtoMessage() {}

func (x *ParSigExchangeMsg) ProtoReflect() protoreflect.Message {
	mi := &file_core_corepb_v1_parsigex_proto_msgTypes[0]
...
// Deprecated: Use ParSigExchangeMsg.ProtoReflect.Descriptor instead.
func (*ParSigExchangeMsg) Descriptor() ([]byte, []int) {
	return file_core_corepb_v1_parsigex_proto_rawDescGZIP(), []int{0}
}

func (x *ParSigExchangeMsg) GetDuty() *Duty {
	if x != nil {
		return x.Duty
	}
	return nil
...
func (x *ParSigExchangeMsg) GetDataSet() *ShareSignedDataSet {
	if x != nil {
		return x.DataSet
	}
	return nil
...
var file_core_corepb_v1_parsigex_proto_rawDesc = []byte{
	...
	,
}
...
var file_core_corepb_v1_parsigex_proto_goTypes = []interface{}{
	(*ParSigExchangeMsg)(nil),  // 0: core.corepb.v1.ParSigExchangeMsg
...
var file_core_corepb_v1_parsigex_proto_depIdxs = []int32{
	1, // 0: core.corepb.v1.ParSigExchangeMsg.duty:type_name -> core.corepb.v1.Duty
	2, // 1: core.corepb.v1.ParSigExchangeMsg.data_set:type_name -> core.corepb.v1.ShareSignedDataSet
...
func file_core_corepb_v1_parsigex_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_core_corepb_v1_parsigex_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ParSigExchangeMsg); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
