...
func TestFetchUniversalBlocks(t *testing.T) {
	ctx := context.Background()
	...
	defSet := core.DutyDefinitionSet{
		pubkeysByIdx[vIdxA]: core.NewUniversalProposerDefinition(&dutyA, "100"),
		pubkeysByIdx[vIdxB]: core.NewUniversalProposerDefinition(&dutyB, "200"),
	}
