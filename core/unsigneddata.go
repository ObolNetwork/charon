...
// Root returns the proposal block root, handling the EPBS arm carrying proposals from
// the gloas fork onwards, which the embedded client union has no knowledge of. Note the
