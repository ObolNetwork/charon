...
func (_m *Handler) Address() string {
	ret := _m.Called()
...
func (_m *Handler) Proxy(ctx context.Context, req *http.Request) (*http.Response, error) {
...
func (_m *Handler) SubmitExecutionPayloadEnvelope(ctx context.Context, opts *api.SubmitExecutionPayloadEnvelopeOpts) error {
	ret := _m.Called(ctx, opts)
