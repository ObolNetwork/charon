...
`
	...
	interfaces = map[string]latencyLog{
		...
		"ExecutionPayloadEnvelopeSubmitter":     {Latency: true, Log: false},
		"ExecutionPayloadProvider":              {Latency: true, Log: false},
