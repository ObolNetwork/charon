...
func (_m *Client) CompleteValidators(_a0 context.Context) (eth2wrap.CompleteValidators, error) {
	ret := _m.Called(_a0)

	if len(ret) == 0 {
		panic("no return value specified for CompleteValidators")
	}

	var r0 eth2wrap.CompleteValidators
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (eth2wrap.CompleteValidators, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(context.Context) eth2wrap.CompleteValidators); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(eth2wrap.CompleteValidators)
		}
	}
...
func (_m *Client) PTCDuties(ctx context.Context, opts *api.PTCDutiesOpts) (*api.Response[[]*v1.PTCDuty], error) {
	ret := _m.Called(ctx, opts)
...
func (_m *Client) PayloadAttestationData(ctx context.Context, opts *api.PayloadAttestationDataOpts) (*api.Response[*spec.VersionedPayloadAttestationData], error) {
	ret := _m.Called(ctx, opts)
...
func (_m *Client) SetValidatorCache(_a0 func(context.Context) (eth2wrap.ActiveValidators, eth2wrap.CompleteValidators, error)) {
	_m.Called(_a0)
}
...
// SignedExecutionPayloadEnvelope provides a mock function with given fields: ctx, opts
func (_m *Client) SignedExecutionPayloadEnvelope(ctx context.Context, opts *api.SignedExecutionPayloadEnvelopeOpts) (*api.Response[*spec.VersionedSignedExecutionPayloadEnvelope], error) {
	ret := _m.Called(ctx, opts)

	if len(ret) == 0 {
		panic("no return value specified for SignedExecutionPayloadEnvelope")
	}

	var r0 *api.Response[*spec.VersionedSignedExecutionPayloadEnvelope]
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *api.SignedExecutionPayloadEnvelopeOpts) (*api.Response[*spec.VersionedSignedExecutionPayloadEnvelope], error)); ok {
		return rf(ctx, opts)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *api.SignedExecutionPayloadEnvelopeOpts) *api.Response[*spec.VersionedSignedExecutionPayloadEnvelope]); ok {
		r0 = rf(ctx, opts)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*api.Response[*spec.VersionedSignedExecutionPayloadEnvelope])
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *api.SignedExecutionPayloadEnvelopeOpts) error); ok {
		r1 = rf(ctx, opts)
	} else {
		r1 = ret.Error(1)
	}
...
// SubmitExecutionPayloadEnvelope provides a mock function with given fields: ctx, opts
func (_m *Client) SubmitExecutionPayloadEnvelope(ctx context.Context, opts *api.SubmitExecutionPayloadEnvelopeOpts) error {
	ret := _m.Called(ctx, opts)

	if len(ret) == 0 {
		panic("no return value specified for SubmitExecutionPayloadEnvelope")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *api.SubmitExecutionPayloadEnvelopeOpts) error); ok {
		r0 = rf(ctx, opts)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *Client) SubmitPayloadAttestationMessages(ctx context.Context, opts *api.SubmitPayloadAttestationMessagesOpts) error {
	ret := _m.Called(ctx, opts)
