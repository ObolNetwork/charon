...
func (_m *Client) BeaconStateCommittees(ctx context.Context, slot uint64) ([]*statecommittees.StateCommittee, error) {
	...
	var r0 []*statecommittees.StateCommittee
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uint64) ([]*statecommittees.StateCommittee, error)); ok {
		return rf(ctx, slot)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uint64) []*statecommittees.StateCommittee); ok {
		r0 = rf(ctx, slot)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*statecommittees.StateCommittee)
		}
	}
