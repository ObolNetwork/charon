...
func file_app_protonil_testdata_v1_test_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_app_protonil_testdata_v1_test_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*M1); i {
			case 0:
				return &v.state
			case 1:
		...
		file_app_protonil_testdata_v1_test_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*M2); i {
			case 0:
				return &v.state
			case 1:
		...
		file_app_protonil_testdata_v1_test_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*M3); i {
			case 0:
				return &v.state
			case 1:
		...
		file_app_protonil_testdata_v1_test_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*M4); i {
			case 0:
				return &v.state
			case 1:
		...
		file_app_protonil_testdata_v1_test_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_app_protonil_testdata_v1_test_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*Attack); i {
			case 0:
				return &v.state
			case 1:
