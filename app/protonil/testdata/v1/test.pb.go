...
var file_app_protonil_testdata_v1_test_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x65, 0x22, 0x1e, 0x0a, 0x08, 0x4d, 0x61, 0x78, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x12,
...
var file_app_protonil_testdata_v1_test_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_app_protonil_testdata_v1_test_proto_goTypes = []interface{}{
	...
	(*MaxIndex)(nil), // 3: app.protonil.testdata.v1.MaxIndex
	(*Attack)(nil),   // 4: app.protonil.testdata.v1.Attack
}
var file_app_protonil_testdata_v1_test_proto_depIdxs = []int32{
	...
	1, // 4: app.protonil.testdata.v1.Attack.m2:type_name -> app.protonil.testdata.v1.M2
	1, // 5: app.protonil.testdata.v1.Attack.m2_optional:type_name -> app.protonil.testdata.v1.M2
	2, // 6: app.protonil.testdata.v1.Attack.m3_unknown:type_name -> app.protonil.testdata.v1.M3
	2, // 7: app.protonil.testdata.v1.Attack.m3_attack:type_name -> app.protonil.testdata.v1.M3
...
func file_app_protonil_testdata_v1_test_proto_init() {
	...
	file_app_protonil_testdata_v1_test_proto_msgTypes[4].OneofWrappers = []interface{}{}
	type x struct{}
